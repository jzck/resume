...
\raggedright
    ...
    \skilldesc{Upkeeping of a media homeserver for family and friends, a 10TiB film library for \textasciitilde{}15 users. I've often used this as an excuse to try out technologies I'm interested in such as \texttt{docker}, \texttt{zfs}, \texttt{prometheus}, \texttt{grafana} etc...}
\end{minipage}
